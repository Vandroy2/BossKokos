            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                              @if(isset($setting))
                              action="{{ route('admin.settings.update', ['setting' => $setting->id]) }}"
                              @else
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="uk" role="tabpanel" aria-labelledby="uk-tab"><br>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="setting_type" class="form-control"
                                                       @isset($setting)
                                                       value="{{ old('setting_type') ? old('setting_type') : $setting->setting_type}}"
                                                       @else
                                                       value="{{old('setting_type')}}"
                                                    @endisset
                                                >
                                            </div>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="setting_email" class="form-control"
                                                       @isset($setting)
                                                       value="{{ old('setting_email') ? old('setting_email') : $setting->setting_email}}"
                                                       @else
