                    ...
                    <div class="row page-titles mx-0">
                        <a href="{{ route('admin.news.create') }}">
                            <button type="button" class="btn btn-primary">
                                ...
                                <span style="font-weight: bold">Добавить новость</span>
                            </button>
                        </a>
                    </div>
                            ...
                            <table class="table table-bordered verticle-middle table-responsive-sm">
                                ...
                                @foreach($news as $oneNews)
                                    <tr>
                                        ...
                                        <td>{!!strip_tags(substr($oneNews->content_ru,0,120))!!}...</td>
                                        <td><span><a href="{{ route('admin.news.edit',$oneNews->id) }}" class="mr-4 btn btn-info" data-toggle="tooltip"
                                                     data-placement="top" title="Edit"><i
                                                        class="fa fa-pencil color-muted"></i> </a>
                                                <form action="{{ route('admin.news.destroy',$oneNews->id) }}" method="POST" style="display:inline-block">
